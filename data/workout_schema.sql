...
CREATE TABLE IF NOT EXISTS "session_exercise_metrics" (
	...
	"metric_description"	TEXT,
	"type"	TEXT NOT NULL CHECK("type" IN ('int', 'float', 'str', 'bool', 'enum', 'slider')),
	"input_timing"	TEXT NOT NULL CHECK("input_timing" IN ('preset', 'pre_workout', 'post_workout', 'pre_session', 'post_session', 'pre_exercise', 'post_exercise', 'pre_set', 'post_set')),
	"scope"	TEXT NOT NULL CHECK("scope" IN ('exercise', 'set')),
	"is_required"	BOOLEAN NOT NULL DEFAULT 0,
	"enum_values_json"	TEXT,
	"value"	TEXT,
...
CREATE TABLE IF NOT EXISTS "session_session_metrics" (
	...
	"metric_description"	TEXT,
	"type"	TEXT NOT NULL CHECK("type" IN ('int', 'float', 'str', 'bool', 'enum', 'slider')),
	"input_timing"	TEXT NOT NULL CHECK("input_timing" IN ('library', 'preset', 'pre_workout', 'post_workout', 'pre_session', 'post_session', 'pre_exercise', 'post_exercise', 'pre_set', 'post_set')),
	"scope"	TEXT NOT NULL CHECK("scope" IN ('preset', 'session')),
	"is_required"	BOOLEAN NOT NULL DEFAULT 0,
	"enum_values_json"	TEXT,
	"value"	TEXT,
